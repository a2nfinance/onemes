task("clear-pending-requests", "clear pending transfer requests").addParam("contractaddress", "address of AutomatedFunctionsConsumer.sol").setAction(async (taskArgs, hre) => {
