            ...
            <>
                ...
                <Alert style={{ borderRadius: 0, border: 0 }} type="info" message={
                    accounts.length ? <Text>
                        ...
                        For <b>testing crosschain transfers</b>, fund your account contract with <a href="https://faucets.chain.link/fuji" target="blank">Link tokens</a> and the corresponding supported crosschain chain tokens <a href="https://docs.chain.link/ccip/test-tokens#mint-tokens-in-the-documentation" target="_blank">CCIP-BnM or CCIP-LnM</a>.
